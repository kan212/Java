...
/**
 * Project Name:1.5.6输入两整数，从数列1,2,3...n中取数 File Name:Test.java Package Name:
 * Date:2015-3-23上午11:00:32 Copyright (c) 2015, shixi_hongtao@staff.sina.com.cn
 * All Rights Reserved.
 * 
 */
...
public class Test  {
	...
	/**
	 * 求解思路： 1.首先判断，如果n>m,则n中大于m的数不可能参与组合，此时置n=m；
