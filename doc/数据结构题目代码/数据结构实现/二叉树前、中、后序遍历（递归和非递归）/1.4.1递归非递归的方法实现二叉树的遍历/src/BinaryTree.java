/**
 * Project Name:1.4.1递归非递归的方法实现二叉树的遍历
 * File Name:Test.java
 * Package Name:
 * Date:2015-3-22上午11:51:30
...
public class BinaryTree {
	...
	protected static void iterativePreorder(Node p) {
		...
		if (p != null) {
			...
			while (!stack.empty()) {
				...
				if (p.getLeft() != null) // 为什么p.getLeft()
											// 在后，getRight()在前应为while 循环第一句就是pop
	...
	/** 非递归实现后序遍历 双栈法 */
	protected static void iterativePostorder2(Node p) {// 理解左子树 右子树
														// 根递归性质，把它运用到循环当中去。
